    ...
    <footer className="bg-tertiary text-background py-10">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-10">
        ...
        <div>
          ...
          <ul className="text-md space-y-2 text-secondary ">
            ...
            <li>
              <Link
                href="https://www.tsu.edu.ph/publications/"
                target="_blank"
                className="hover:text-background"
              >
                Publications
            ...
            <li>
              <Link
                href="https://www.tsu.edu.ph/news/"
                target="_blank"
                className="hover:text-background"
              >
                News
      ...
      <div className="border-t border-gray-600 mt-8 pt-4 text-center text-lg" >
        ...
        <div className="text-sm mt-2 space-x-4 text-secondary">
          <Link
            href="https://www.tsu.edu.ph/legal/"
            target="_blank"
            className="hover:text-background"
          >
            Legal
          ...
          <Link
            href="https://www.tsu.edu.ph/privacy/"
            target="_blank"
            className="hover:text-background"
          >
            Privacy
          ...
          <Link
            href="https://www.tsu.edu.ph/terms-of-service/"
            target="_blank"
            className="hover:text-background"
          >
            Terms of Service
          ...
          <Link
            href="https://www.tsu.edu.ph/accessibility/"
            target="_blank"
            className="hover:text-background"
          >
            Accessibility
